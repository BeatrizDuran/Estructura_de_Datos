...
namespace esdat
{
    public partial class Memorama_g : Form
    {
        public Memorama_g(int nivel, string nombre)
        {
            InitializeComponent();
            this.nivel = nivel;
           // this.nombre = nombre;
        ...
        private void flip(PictureBox voltear, int elemento)
        {
            ...
            {
                intentos++;
                toolStripStatusLabel1.Text = "Intentos: " + intentos.ToString();
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Felicidades!: "+InicioMemorama.nombre +" eres un genio!. Intentos = "+intentos);
                    }
                    ...
                    {
                        MessageBox.Show("Muy bien!: " + InicioMemorama.nombre + " practica más. Intentos = "+intentos);
                    }
                    else if (pictureBox1.Visible == false && pictureBox2.Visible == false && pictureBox3.Visible == false && pictureBox4.Visible == false && pictureBox5.Visible == false &&
                        pictureBox5.Visible == false && pictureBox6.Visible == false && pictureBox7.Visible == false && pictureBox8.Visible == false && pictureBox9.Visible == false &&
                        pictureBox10.Visible == false && pictureBox11.Visible == false && pictureBox12.Visible == false && pictureBox13.Visible == false && pictureBox14.Visible == false &&
                    ...
                    {
                        MessageBox.Show("Lo siento: " + InicioMemorama.nombre + " no sirves para esto. Intentos = " + intentos);
                    }
        ...
        {            
            tslblINGRESENOMBRE.Text = "Participante: " + InicioMemorama.nombre;
            restart();
            // axWMP.URL=@"C...";
            axWMP.Visible = false;
        }
