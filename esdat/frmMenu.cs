...
namespace esdat
{
    public partial class frmMenu : Form
    {
        ...
        private void inversaToolStripMenuItem_Click(object sender, EventArgs e) => new Matrices().ShowDialog();
        private void transpuestaToolStripMenuItem_Click(object sender, EventArgs e) => new frmMenuTranspuestas().ShowDialog();
        private void salirToolStripMenuItem_Click(object sender, EventArgs e) => this.Close();
        private void acercaDeToolStripMenuItem_Click(object sender, EventArgs e) => new About().ShowDialog();
    }
}